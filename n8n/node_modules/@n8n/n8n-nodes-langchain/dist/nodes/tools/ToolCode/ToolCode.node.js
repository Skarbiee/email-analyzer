  ...
  constructor() {
    this.description = {
      ...
      properties: [
        ...
        (0, import_descriptions.buildJsonSchemaExampleField)({ showExtraProps: { specifyInputSchema: [true] } }),
        (0, import_descriptions.buildInputSchemaField)({ showExtraProps: { specifyInputSchema: [true] } })
      ]
    };
  }
