...
var Freshdesk_node_exports = {};
__export(Freshdesk_node_exports, {
  Freshdesk: () => Freshdesk
});
module.exports = __toCommonJS(Freshdesk_node_exports);
  ...
  constructor() {
    ...
    this.methods = {
      loadOptions: {
        ...
        async getAgents() {
          const returnData = [];
          const agents = await import_GenericFunctions.freshdeskApiRequest.call(this, "GET", "/agents");
        ...
        async getGroups() {
          const returnData = [];
          const groups = await import_GenericFunctions.freshdeskApiRequest.call(this, "GET", "/groups");
        ...
        async getProducts() {
          const returnData = [];
          const products = await import_GenericFunctions.freshdeskApiRequest.call(this, "GET", "/products");
        ...
        async getCompanies() {
          const returnData = [];
          const companies = await import_GenericFunctions.freshdeskApiRequest.call(this, "GET", "/companies");
      ...
      try {
        if (resource === "ticket") {
          if (operation === "create") {
            ...
            const body = {
              // @ts-ignore
              status: Status[(0, import_GenericFunctions.capitalize)(status)],
              // @ts-ignore
              priority: Priority[(0, import_GenericFunctions.capitalize)(priority)],
              // @ts-ignore
              source: Source[(0, import_GenericFunctions.capitalize)(source)]
            };
            if (requester === "requesterId") {
              if (isNaN(value)) {
                throw new import_n8n_workflow.NodeOperationError(this.getNode(), "Requester Id must be a number", {
                  itemIndex: i
                });
              }
            ...
            responseData = await import_GenericFunctions.freshdeskApiRequest.call(this, "POST", "/tickets", body);
          }
          if (operation === "update") {
            ...
            if (updateFields.status) {
              body.status = Status[(0, import_GenericFunctions.capitalize)(updateFields.status)];
            }
            if (updateFields.priority) {
              body.priority = Priority[(0, import_GenericFunctions.capitalize)(updateFields.priority)];
            }
            if (updateFields.source) {
              body.source = Source[(0, import_GenericFunctions.capitalize)(updateFields.source)];
            }
            ...
            responseData = await import_GenericFunctions.freshdeskApiRequest.call(
              this,
              "PUT",
              `/tickets/${ticketId}`,
              body
          ...
          if (operation === "get") {
            const ticketId = this.getNodeParameter("ticketId", i);
            responseData = await import_GenericFunctions.freshdeskApiRequest.call(this, "GET", `/tickets/${ticketId}`);
          }
          if (operation === "getAll") {
            ...
            if (returnAll) {
              responseData = await import_GenericFunctions.freshdeskApiRequestAllItems.call(
                this,
                "GET",
                "/tickets",
                {},
              ...
              responseData = await import_GenericFunctions.freshdeskApiRequest.call(this, "GET", "/tickets", {}, qs);
            }
          }
          if (operation === "delete") {
            const ticketId = this.getNodeParameter("ticketId", i);
            responseData = await import_GenericFunctions.freshdeskApiRequest.call(this, "DELETE", `/tickets/${ticketId}`);
          }
          ...
          if (operation === "create") {
            ...
            responseData = await import_GenericFunctions.freshdeskApiRequest.call(this, "POST", "/contacts", body);
            ...
            responseData = await import_GenericFunctions.freshdeskApiRequest.call(this, "GET", "/contacts", {}, filters);
