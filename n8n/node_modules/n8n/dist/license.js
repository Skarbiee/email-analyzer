...
let License = class License {
    ...
    isFoldersEnabled() {
        return this.isFeatureEnabled(constants_1.LICENSE_FEATURES.FOLDERS);
    }
    isInsightsSummaryEnabled() {
        return this.isFeatureEnabled(constants_1.LICENSE_FEATURES.INSIGHTS_VIEW_SUMMARY);
    }
    isInsightsDashboardEnabled() {
        return this.isFeatureEnabled(constants_1.LICENSE_FEATURES.INSIGHTS_VIEW_DASHBOARD);
    }
    isInsightsHourlyDataEnabled() {
        return this.getFeatureValue(constants_1.LICENSE_FEATURES.INSIGHTS_VIEW_HOURLY_DATA);
    }
    ...
    getInsightsMaxHistory() {
        return this.getFeatureValue(constants_1.LICENSE_QUOTAS.INSIGHTS_MAX_HISTORY_DAYS) ?? 7;
    }
    getInsightsRetentionMaxAge() {
        return this.getFeatureValue(constants_1.LICENSE_QUOTAS.INSIGHTS_RETENTION_MAX_AGE_DAYS) ?? 180;
    }
    getInsightsRetentionPruneInterval() {
        return this.getFeatureValue(constants_1.LICENSE_QUOTAS.INSIGHTS_RETENTION_PRUNE_INTERVAL_DAYS) ?? 24;
    }
    getTeamProjectLimit() {
