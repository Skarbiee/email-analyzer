...
require("./evaluation.ee/test-definitions.controller.ee");
...
let Server = class Server extends abstract_server_1.AbstractServer {
    ...
    async registerAdditionalControllers() {
        if (!constants_1.inProduction && this.instanceSettings.isMultiMain) {
    ...
    async configure() {
        ...
        di_1.Container.get(decorators_1.ControllerRegistry).activate(app);
